 The AWS exports to S3 are sharded into 10-15 CSV's per export. I download the individual forecasts, and aggregate them using the following Python script to concatanate the multiple files:
