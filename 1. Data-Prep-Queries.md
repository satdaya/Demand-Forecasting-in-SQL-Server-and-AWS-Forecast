...
The query below sets the frcst_qty to the mean when the frcst_qty is greater than 2x standard deviation. The cte_metrics below uses windows functions to approximate to determine the average and standard deviations by item_id and keycust4.
            ...
            FROM
               (
                SELECT  [AWS_Stage].[item_id]
				  ...
				  -- AND [AWS_Stage].[trailing_6] = [last_6_month cte].[trailing_6]
     ...
     ( [year_month]  
      ...
      ,[frcst_qty]
            ...
            SELECT  [ym_cte].[year_month]
				   ...
				   ,CASE WHEN ABS ( SUM([cte_metrics].[sum_frcst_qty]) - SUM([cte_metrics].[avg_frcst_qty]) ) > ABS ( SUM([cte_metrics].[stddev_frcst_qty]) * 2 ) THEN SUM([cte_metrics].[avg_frcst_qty])
